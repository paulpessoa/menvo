...
export function MentorAvailabilitySettings({
  isOpen,
  onClose
}: MentorAvailabilitySettingsProps) {
  ...
  const { data: availability_status } = useMentorAvailability(mentorId)
        ...
        <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-end">
                  <Button
                    ...
                    disabled={
                      !isValidSlot(newSlot) || addAvailabilityMutation.isPending
                    }
                    className="w-full"
                  >
                          ...
                          {daySlots.map((slot, index) => (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <Badge
                                  variant={
                                    slot.is_active ? "default" : "secondary"
                                  }
                                >
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              ...
              <p>
                • Use o switch para ativar/desativar horários temporariamente
              </p>
              <p>• Sessões de mentoria têm duração padrão de 1 hora</p>
              <p>
                • Você receberá notificações de novas solicitações por email
              </p>
            </CardContent>
          </Card>
        </div>
