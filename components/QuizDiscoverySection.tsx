        ...
        <div className="rounded-3xl border border-primary/20 bg-card/80 backdrop-blur-md p-8 md:p-14 shadow-xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-sm rounded-2xl bg-gradient-to-br from-primary/15 via-primary/10 to-primary/5 p-6 border border-border shadow-inner space-y-4">
