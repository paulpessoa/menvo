    ...
    Tables: {
      ...
      z_deleted_cv_metadata: {
        Row: {
          ...
          extracted_languages: string[] | null
      ...
      z_deleted_mentor_partners: {
        ...
        Relationships: [
          {
            foreignKeyName: "mentor_partners_mentor_id_fkey"
            columns: ["mentor_id"]
            isOneToOne: false
            referencedRelation: "mentors_admin_view"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "mentor_partners_partner_id_fkey"
            columns: ["partner_id"]
            isOneToOne: false
            referencedRelation: "z_deleted_partners"
            referencedColumns: ["id"]
          },
        ]
      }
      z_deleted_mentorship_requests: {
        Row: {
          created_at: string
          cv_type: string | null
          cv_url: string | null
      ...
      z_deleted_migration_audit_logs: {
        Row: {
          action: string
          details: Json | null
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "migration_audit_logs_migration_id_fkey"
            columns: ["migration_id"]
            isOneToOne: false
            referencedRelation: "z_deleted_user_migrations"
            referencedColumns: ["id"]
          },
        ]
      }
      z_deleted_partner_invitations: {
        Row: {
      ...
      z_deleted_volunteer_activities: {
        Row: {
          activity_type: string
          created_at: string | null
          date: string
