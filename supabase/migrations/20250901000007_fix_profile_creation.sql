-- =================================================================
-- FIX PROFILE CREATION TO INCLUDE USER METADATA
-- Update trigger to save first_name, last_name, full_name from auth metadata
-- =================================================================

-- Drop and recreate the handle_new_user function to include metadata
