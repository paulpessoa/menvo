-- =================================================================
-- MENVO - SYNC USER METADATA WITH PROFILES
-- This migration creates a trigger to sync profile data with auth.users metadata
-- =================================================================
...
-- Update the JWT hook to include more comprehensive claims
...
-- Run initial sync for all existing profiles
SELECT public.sync_all_user_metadata();