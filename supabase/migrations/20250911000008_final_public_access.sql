-- Final solution: Enable public access to mentors_view
-- Remove existing conflicting policies and create a simple public access policy

-- Drop existing policy if it exists
DROP POLICY IF EXISTS "public_can_view_verified_mentors_profiles" ON public.profiles;

-- Create a comprehensive policy for public mentor access
CREATE POLICY "anon_can_view_verified_mentors" ON public.profiles
  FOR SELECT
...
-- Recreate mentors_view to ensure it works
