...
-- This script adds the essential functions and triggers to the database
-- Execute this in Supabase SQL Editor after the main migration
-- =================================================================
...
AND t.tgname IN ('on_auth_user_created', 'generate_profile_slug_trigger', 'update_profiles_updated_at', 'update_roles_updated_at', 'update_validation_requests_updated_at');