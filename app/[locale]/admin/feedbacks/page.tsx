...
import { Star, TrendingUp, Users, MessageSquare, Search, Download, Loader2, RefreshCw } from "lucide-react"
            ...
            <div className="container mx-auto px-4 py-8 space-y-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground">Gerencie e analise os feedbacks recebidos.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Card className="border-l-4 border-l-yellow-500">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{stats.avg.toFixed(1)} / 5.0</div>
                        </CardContent>
                    </Card>
                    <Card className="border-l-4 border-l-green-500">
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-muted-foreground">Promotores (4-5 ★)</CardTitle>
                        </CardHeader>
                        <CardContent>
                                            ...
                                            <TableRow key={f.id}>
                                                ...
                                                <TableCell>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-[10px] text-muted-foreground">{f.profiles?.email}</span>
                                                    </div>
                                                </TableCell>
                                                <TableCell>
