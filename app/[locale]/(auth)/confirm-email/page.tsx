    ...
    try {
      ...
      if (error) {
        ...
        if (error.message.includes("expired")) {
          setStatus("expired")
          setMessage(
            "O link de confirmação expirou. Use o código OTP ou solicite um novo."
          )
        } else {
          setStatus("manual")
          setMessage(
            "Link inválido. Digite o código de 6 dígitos enviado para seu email."
          )
        }
        await getUserEmail()
        return
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            ...
            {status === "manual" &&
              "Digite o código de 6 dígitos ou use o link do email."}
            {(status === "error" || status === "expired") &&
              "Use o código OTP ou solicite um novo."}
          </CardDescription>
        </CardHeader>
