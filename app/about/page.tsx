...
export default function AboutPage() {
  ...
  return (
    <div className="container py-8 md:py-12">
      ...
      <div className="mb-16">
        <h2 id="sdg" className="text-2xl font-bold text-center mb-8">
          {t("about.sdg.title")}
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={goal.number}
              id={goal.id}
              className={`p-4 rounded-lg ${goal.color} flex flex-col items-center text-center`}
            >
              <div className="font-bold text-xl mb-2">
                {t("about.sdg.goalNumber", { number: goal.number })}
              </div>
              <div>{goal.title}</div>
            </div>
          ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
        ...
        <div className="space-y-6">
          <h2 id="team" className="text-2xl font-bold scroll-mt-20">
      ...
      <div className="bg-primary-600 text-primary-foreground rounded-lg p-8 md:p-12 mb-16">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p>{t("about.ourImpact.description")}</p>
        </div>
      </div>
