      ...
      <div className="container mx-auto py-8 px-4">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Não foi possível carregar as estatísticas de voluntariado.
          </p>
        </div>
      </div>
    )
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-lg">
            Acompanhe o impacto das atividades de voluntariado em nossa
            comunidade
          </p>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {stats.total_activities > 0
                  ? (stats.total_hours / stats.total_activities).toFixed(1)
                  : 0}
                h
              </div>
              <p className="text-xs text-muted-foreground">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Evolução das atividades nos últimos meses
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
